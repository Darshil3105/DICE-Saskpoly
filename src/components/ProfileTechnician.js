                    ...
                    <form onSubmit={this.onSubmit}>
                        ...
                        <div className="form-edit">
                            ...
                            <div className="form-edit-fields">
                                ...
                                <textarea value={this.state.about_me} onChange={this.onChangeAbout} placeholder="Background History...!!" />
                            </div>
                            <div className="form-edit-fields">
                                <label>Hobbies:</label>
                                <input type="text" value={this.state.hobbies} onChange={this.onChangeHobbies} placeholder="Tell me your hobbies..."/>
                            </div>
                            <div className="form-edit-fields">
                                <label>Contact Info:</label>
                                <input type="text" value={this.state.contact_details} onChange={this.onChangeContact} placeholder="306-234-XXXX" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" />
                            </div>
                            ...
                            <div className="form-edit-fields">
                                <p><Link to = "/assignprojectfortech">Administrate Project Here!</Link></p>
                            </div>
