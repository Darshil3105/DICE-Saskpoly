                    ...
                    <form onSubmit={this.onSubmit}>
                        ...
                        <div className="form-edit">
                            ...
                            <div className="form-edit-fields">
                                ...
                                <select required value={this.state.researcher} onChange={this.onChangeResearcher}>
                                    {
                            ...
                            <div className="form-edit-fields">
                                ...
                                <select required value={this.state.technician} onChange={this.onChangeTechnician}>
                                    {
                            ...
                            <div className="form-edit-fields">
                                ...
                                <select required value={this.state.student} onChange={this.onChangeStudent}>
                                    {
